...
class MpkDashboardPage extends StatelessWidget {
  const MpkDashboardPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Hallo, MPK', style: TextStyle(fontWeight: FontWeight.bold)),
          ...
          children: [
            Row(
              children: [
                Expanded(
                  child: Card(
                    color: Colors.amber.shade800, // Ciri khas warna oranye MPK
            ...
            const Text('MENU UTAMA MPK', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
