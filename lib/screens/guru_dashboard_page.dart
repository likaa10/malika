...
class GuruDashboardPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Hallo, Guru', style: TextStyle(fontWeight: FontWeight.bold)),
          ...
          children: [
            Row(
              children: [
                Expanded(
                  child: Card(
                    color: Colors.green.shade700, // Ciri khas warna hijau Guru
            ...
            const Text('MENU UTAMA GURU', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
